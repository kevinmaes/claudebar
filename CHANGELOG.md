...
- e2fd78e: Remove misleading context window percentage and progress bar display
...
- df4a055: Add NO_COLOR environment variable support for accessibility

### Patch Changes

- 321ab41: Fix CLI hang when using commands like 'update' without dashes
